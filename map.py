# -*- coding: utf-8 -*-
"""02806_DateSliderMap.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/LarsBryld/socialdataanalysis2020/blob/master/02806_DateSliderMap.ipynb
"""
...
from bokeh.models import GeoJSONDataSource, LinearColorMapper, ColorBar, Slider, HoverTool, Paragraph
...
# Select one particular day of data for plotting
df_15thApril = df[df['Date'] == datetime(2020, 4, 15, 0, 0)]

"""### Define a function to merge our Dataframe with GeoData"""
...
"""## Plotting a DateSlider Map using Bokeh"""

#Input GeoJSON source that contains features for plotting.
geosource = GeoJSONDataSource(geojson = json_data(datetime(2020, 4, 15, 0, 0)))
...
welcome_message = 'This tab demonstrates the covid index as described in the explanatory file. This demonstrates the relation between stock market performance and death rate pr. country. '
welcome_banner = Paragraph(text=welcome_message)

# Make a tab with the layout 
# Make a tab with the layout 
layout = gridplot([[column(welcome_banner)], 
                   [layout]], 
